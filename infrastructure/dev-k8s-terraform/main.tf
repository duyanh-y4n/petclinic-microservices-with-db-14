...
resource "aws_instance" "kube-master" {
  ...
  key_name = "tutorial-north-virginia"
  subnet_id = "subnet-0556260e8a93091f3"  # select own subnet_id of us-east-1a
...
resource "aws_instance" "worker-2" {
  ...
  vpc_security_group_ids = [aws_security_group.k8s-sec-gr.id]
  key_name = "tutorial-north-virginia"
  subnet_id = "subnet-0556260e8a93091f"  # select own subnet_id of us-east-1a
  availability_zone = "us-east-1a"
  tags = {
    Name = "worker-2"
    Project = "tera-kube-ans"
